...
jQuery(function($){
	...
	$(window).resize(function(){
		...
		bricks.css({width:size-1,height:size-1});

		var metro1 = $('.content-holder .container.visible-phone:visible');
		var bricks1 = metro1.find('.brick1');
		var size1 = metro1.width()/2;
		bricks1.css({width:size1-1,height:size1-1});
